    ...
    <div className={small ? styles.smallNavComp : styles.navComponent} id="nav">
      ...
      <div className={styles.navCenter}>
        ...
        <div className={styles.navLinks}>
          ...
          <Col ><a className={router.pathname == "/services" ? styles.active : styles.inactive} id="links" href="#">Services</a></Col>
          <Col ><a className={router.pathname == "/gallery" ? styles.active : styles.inactive} id="links" href="#">Gallery</a></Col>
          <Col ><a className={router.pathname == "/contact" ? styles.active : styles.inactive} id="links" href="#">Contact</a></Col>
          <Col ><a className={router.pathname == "/quote" ? styles.active : styles.inactive} id="links" href="#">Quote</a></Col>
      ...
      <div className={styles.navRight}>
        <div>
          <a title='Call Now' href="tel:7324239671">
